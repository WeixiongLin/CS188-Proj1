...
class DynamicModel(object):
    ...
    def __init__(self,config):
        ...
        self.store_dir = config['store_config']['store_path']
    ...
    def train(self, trainset, testset=0):
        ...
        for epoch in range(1, self.n_epochs + 1):
            ...
            if self.save_loss_fig and epoch % self.save_loss_fig_frequency == 0:
                self.save_figure(epoch, loss_epochs, loss_this_epoch, self.store_dir)
                if testset != 0:
    ...
    def save_figure(self, epoch, loss_epochs, loss_this_epoch, store_path="storage"):
        '''
        ...
        plt.savefig(store_path + "/loss-" + str(self.exp_number) + ".png")
    ...
    def plot_model_validation(self, env, horizon=40, n_sample=200, mpc=[], mode="mean", store_path="storage"):
        ...
        for i in range(errors.shape[1]):
            ...
            plt.legend()
        plt.savefig(store_path + "/model_error_exp_"+str(self.exp_number)+".png")
        plt.show()
